...
const {cloneDeep, compact, remove} = require('lodash')
...
BusCrawler.prototype.getScheduleTimes = function (cheerioPage) {
  ...
  let result = this.chunkScheduleByPeriod({dawn, morning, afternoon, night})
  // TODO: const observationInfo = '<p class="textosm">'

  return result
}

BusCrawler.prototype.chunkScheduleByPeriod = function () {
  let result
